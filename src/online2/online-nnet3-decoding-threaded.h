// online2/online-nnet3-decoding-threaded.h
...
#ifndef KALDI_ONLINE2_ONLINE_NNET3_DECODING_THREADED_H_
#define KALDI_ONLINE2_ONLINE_NNET3_DECODING_THREADED_H_
...
/**
   class Nnet3ThreadSynchronizer acts to guard an arbitrary type of buffer between a
   ...
   state of the buffer.
*/
class Nnet3ThreadSynchronizer {
 public:  
  Nnet3ThreadSynchronizer();
  ...
  // on any other Nnet3ThreadSynchronizer classes you are using and then return from
  // the thread.
 ...
 private:
  ...
  KALDI_DISALLOW_COPY_AND_ASSIGN(Nnet3ThreadSynchronizer);
};
...
struct OnlineNnet3DecodingThreadedConfig {
  ...
  OnlineNnet3DecodingThreadedConfig() {
    acoustic_scale = 0.1;
...
/**
   ...
   thread.
*/
class SingleUtteranceNnet3DecoderThreaded {
 public:
  // Constructor.  Unlike SingleUtteranceNnet3Decoder, we create the
 ...
 private:
  ...
  Nnet3ThreadSynchronizer waveform_synchronizer_;
  ...
  Nnet3ThreadSynchronizer decodable_synchronizer_;
